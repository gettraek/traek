---
title: Welcome to Træk Docs
description: Get started building your docs site with Træk.
template: splash # Remove or comment out this line to display the site sidebar on this page.
hero:
  tagline: Congrats on setting up a new Træk project!
  actions:
    - text: Example Guide
      link: /guides/sveltekit/
      icon: right-arrow
    - text: Read the Træk docs
      link: https://docs.gettraek.com
      icon: external
      variant: minimal
---
