	...
	TraekCanvas: {
		...
		props: [
			...
			},
			{
				...
				required: false,
				description:
					'Svelte snippet rendered as an overlay on first load (e.g. welcome screen).',
			},
			{
				name: 'inputActions',
	...
	TraekEngine: {
		...
		stateProps: [
			{
				...
				type: 'Node[]',
				required: false,
				description: 'Reactive array of all nodes. Mutating it (via engine methods) triggers re-renders.',
			},
			{
				name: 'activeNodeId',
				type: 'string | null',
			...
			},
			{
				...
				type: 'Set<string>',
				required: false,
				description: 'Set of node IDs that are collapsed. Descendants of collapsed nodes are hidden.',
			},
			{
				name: 'searchQuery',
				type: 'string',
		...
		methods: [
			...
			},
			{
				name: 'addCustomNode',
				signature:
					'addCustomNode(component: Component, props?, role?, options?): CustomTraekNode',
				description:
			...
			},
			{
				...
				description:
					'Get direct children of a node. Pass null for root nodes.',
			},
			{
				name: 'getParent',
			...
			},
			{
				...
				description:
					'Set activeNodeId to nodeId — next addNode() call will branch from this node.',
			},
			{
				name: 'toggleCollapse',
			...
			},
			{
				...
				description:
					'Move a node (and its descendants) by dx/dy pixels. Sets manualPosition flag.',
			},
		],
		notes: [
	...
	ConversationStore: {
		...
		methods: [
			...
			},
			{
				...
				signature: 'init(): void',
				description:
					'Load conversations from localStorage. Call once in an $effect or onMount.',
			},
			{
		...
		props: [
			{
				...
				required: false,
				default: "'dark'",
				description: "Built-in theme name ('dark', 'light', 'highContrast') or a custom theme object.",
			},
		],
